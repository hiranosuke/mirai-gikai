      ...
      <div className="bg-white rounded-2xl p-6 space-y-4">
        ...
        <div className="text-sm leading-[1.83] text-black space-y-4">
          ...
          <div>
            ...
            <p className="mt-1">
              本インタビューを通じて収集された回答データは、議案に関する論点整理や市民の関心の把握における基礎資料として活用いたします。個人の意見を特定の偏り（バイアス）なく集約し、客観性の高い論点整理に役立てることを目的としています。
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-2 space-y-2 list-none">
              ...
              <li>
                ...
                回答内容は、本サイトにおける議案の論点整理、およびAIを用いた統計的分析に限定して活用いたします。
              </li>
              <li>
            ...
            <div className="mt-3">
              ...
              <ul className="mt-1 space-y-2 list-none">
                <li>
                  ...
                  回答者の承諾なく、原文や個人が特定できる形で外部公開されることはありません。ただし、統計的な集計結果、または個人を特定できない範囲に匿名化した上で、本サイトでの議案の論点整理や分析において引用・活用される場合があります。
                </li>
                <li>
                  <span className="font-bold">公開を希望する場合：</span>
                  回答データは「みらい議会＠さいたま市」上に掲載され、他のユーザーが閲覧可能な状態で公開されます。これにより、利用者間での意見の共有および議論の活性化を図ります。
                </li>
              </ul>
            </div>
          </div>
